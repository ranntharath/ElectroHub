  ...
  <div class="bg-white p-4 rounded-md mt-5">
    <div class="flex justify-between items-center">
      <div>
        <input
          ...
          id="name"
          placeholder="Search..."
          class="px-4 py-1.5 rounded-lg border border-gray-300 focus:border-slate-300 focus:ring-2 focus:ring-slate-200 outline-none transition-all duration-200"
        />
      </div>
    ...
    <table class="w-full mt-4">
      ...
      <tbody class="divide-y divide-gray-200">
        <tr v-for="pro in productStore.response?.products">
